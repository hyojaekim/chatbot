...
class AddressArgumentResolver : HandlerMethodArgumentResolver {
    override fun supportsParameter(parameter: MethodParameter): Boolean {
        return parameter.parameterType.isAssignableFrom(AddressRequestDto::class.java)
    }
    ...
    override fun resolveArgument(parameter: MethodParameter, mavContainer: ModelAndViewContainer?, webRequest: NativeWebRequest, binderFactory: WebDataBinderFactory?): Any? {
        ...
        val address = KduJsonParser.findParams(jsonElement, "address")
        return AddressRequestDto(address)
    }
}